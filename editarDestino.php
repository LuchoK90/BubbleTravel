...
$destino = $conexion->prepare("SELECT * FROM destinos WHERE id=:idDestino");
    ...
    $destino->bindParam(":idDestino", $idDestino, PDO::PARAM_INT);
...
<html lang="en">
 ...
 <hr class="separador" style="margin-top: 0;">
        ...
        <div class="container col-md-12">
          ...
          <h3 class="col-md-12"><i class="fas fa-map-marker-alt"></i> EDITAR DESTINO</h3><br>

          <div class="col-md-12">

           <form action="destinoEditado.php" method="POST">
            <div class="col-md-12" style="float: left;">
          <label class="col-md-3" style="float:left; margin-top: 5px;">NOMBRE: </label> <input class="inputSubir col-md-9" type="text" id="nombre" name="nombre" value="<?php echo $destino["nombre"]; ?>" required><br>
