...
$viaje = $conexion->prepare("SELECT * FROM viaje WHERE id=:idViaje");
...
<html lang="en">
 ...
 <hr class="separador" style="margin-top: 0;">
        ...
        <div class="container col-md-12">
          ...
          <h2 class="col-md-12">EDITAR VIAJE</h2><br>

          <div class="col-md-12">

           <form action="viajeEditado.php" method="POST">
            <div class="col-md-12" style="float: left;">
           <input class="inputSubir col-md-12" type="text" id="nombre" name="nombre" value="<?php echo $viaje["nombre"]; ?>" required><br>
   

<input class="inputSubir col-md-12" type="hidden" id="id" name="id" value="<?php echo $viaje["id"]; ?>" required>


        
        <input class="inputSubir col-md-12" type="text" id="presupuesto" name="presupuesto" value="<?php echo $viaje["presupuesto"]; ?>" required><br>
