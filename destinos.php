...
if ( isset( $busqueda ) ){
      ...
      while ( $destino = $destinos->fetch() ) {
         ...
         $fecha_inicio = strtotime($destino["fecha_inicio"]);
        $fecha_inicio = date("d-m-Y", $fecha_inicio);

        $fecha_fin = strtotime($destino["fecha_fin"]);
    ...
    <div class="card">
      ...
      <div id="collapse<?php echo $destino["id"]; ?>" class="collapse" data-parent="#accordion">
        <div class="card-body">
          <span class="col-md-12 texto-card-body"><b><i class="far fa-calendar-alt"></i> FECHA:</b> <?php echo $fecha_inicio; ?> | <?php echo $fecha_fin; ?></span> 
        </div>
      </div>
    </div><br>
    <?php } ?>
