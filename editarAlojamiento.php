...
$alojamiento = $conexion->prepare("SELECT * FROM alojamiento WHERE id=:idAlojamiento");


    $alojamiento->bindParam(":idAlojamiento", $idAlojamiento, PDO::PARAM_INT);


      $alojamiento->execute(); 

       $alojamiento = $alojamiento->fetch()
...
<html lang="en">
 ...
 <hr class="separador" style="margin-top: 0;">
        ...
        <div class="container col-md-12">
          ...
          <h3 class="col-md-12"> <i class="fas fa-concierge-bell"></i> EDITAR ALOJAMIENTO</h3><br>

          <div class="col-md-12">

           <form action="alojamientoEditado.php" method="POST">
            <div class="col-md-12" style="float: left;">
          <label class="col-md-3" style="float:left; margin-top: 5px;">NOMBRE: </label> <input class="inputSubir col-md-9" type="text" id="nombre" name="nombre" value="<?php echo $alojamiento["nombre"]; ?>" required><br>
