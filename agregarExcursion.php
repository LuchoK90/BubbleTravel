...
<html lang="en">
 ...
 <img class="logo col-md-4" src="imagenes/logo-bubbletravel.jpg">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" href="crearViaje.html">Crear un Viaje</a>
      </li>
      <li class="nav-item ">
 ...
 <hr class="separador" style="margin-top: 0;">
        ...
        <div class="container col-md-12">
          ...
          <h3 class="col-md-12"><i class="fas fa-bus"></i> AGREGAR EXCURSIÓN</h3><br>

          <div class="col-md-12">

           <form action="excursionCreada.php" method="POST">
          ...
          <label class="col-md-3" style="float:left; margin-top: 5px;">NOMBRE: </label> <input class="inputSubir col-md-9" type="text" id="nombre" name="nombre" required><br>
           <label class="col-md-3" style="float:left; margin-top: 5px;">FECHA </label><input class="inputSubir col-md-3" style="float:left;" type="date" id="fechaInicio" name="fechaInicio" required>
         <label class="col-md-3" style="float:left; margin-top: 5px;">VALOR: </label> <input class="inputSubir col-md-3" type="text" id="valor" name="valor" placeholder="($)" required><br>
